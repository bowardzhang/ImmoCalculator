(function () {
  ...
  function buildShareCard() {
    if (typeof html2canvas === 'undefined') { alert('分享图片功能需要加载 html2canvas，请检查网络连接。'); return; }
    var inp = getInputs();
